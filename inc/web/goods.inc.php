...
$category =  pdo_fetchall("SELECT * FROM " . tablename('tg_category') . " WHERE weid = '{$_W['uniacid']}' and parentid=0  ORDER BY id DESC");
...
if ($op == 'display') {
	...
	$psize = 10;
	//设置分页大小
	$condition = " uniacid = '{$_W['uniacid']}' and isshow in(0,1,3)";
